modded class PluginManager
{
	override void Init()
	{
		...
		// RegisterPlugin(className, run on client?, run on server?)
		...
		if (ZenModEnabled("ZenRadioPlugin"))
			RegisterPlugin("ZenRadioPlugin", false, true);
