class ActionZenCheckCauseOfDeathCB : ActionContinuousBaseCB
{
...
class ActionZenCheckCauseOfDeath : ActionContinuousBase
{
    void ActionZenCheckCauseOfDeath()
    {
        m_CallbackClass = ActionZenCheckCauseOfDeathCB;
