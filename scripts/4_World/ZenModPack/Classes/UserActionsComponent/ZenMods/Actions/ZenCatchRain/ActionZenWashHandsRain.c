class ActionZenWashHandsRainCB : ActionContinuousBaseCB
{
...
class ActionZenWashHandsRain : ActionContinuousBase
{
	void ActionZenWashHandsRain()
	{
		m_CallbackClass = ActionZenWashHandsRainCB;
