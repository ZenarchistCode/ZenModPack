class ActionZenOpenCanEnvCB : ActionContinuousBaseCB
{
...
class ActionZenOpenCanEnv : ActionContinuousBase
{
	const static float MIN_LOSS = 0.5;
	const static float MAX_LOSS = 0.8;

	void ActionZenOpenCanEnv()
	{
		m_CallbackClass = ActionZenOpenCanEnvCB;
