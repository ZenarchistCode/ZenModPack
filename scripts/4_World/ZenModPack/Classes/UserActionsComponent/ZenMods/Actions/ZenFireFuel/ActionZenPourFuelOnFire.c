class ActionZenPourFuelOnFireCB : ActionContinuousBaseCB
{
...
class ActionZenPourFuelOnFire : ActionContinuousBase
{
	void ActionZenPourFuelOnFire()
	{
		m_CallbackClass = ActionZenPourFuelOnFireCB;
