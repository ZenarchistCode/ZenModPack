class ActionZenMineCoopHandsCB : ActionContinuousBaseCB
{
...
class ActionZenMineCoopHands : ActionContinuousBase
{
	void ActionZenMineCoopHands()
	{
		m_CallbackClass = ActionZenMineCoopHandsCB;
