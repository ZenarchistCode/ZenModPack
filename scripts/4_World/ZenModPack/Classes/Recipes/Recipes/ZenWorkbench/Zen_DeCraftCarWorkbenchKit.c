class Zen_DeCraftCarWorkbenchKit extends RecipeBase
{
	override void Init()
	{
		string makeItem = "Screwdriver";
		string resourceItem = "Zen_CarWorkbench";
		string resultItem = "Zen_CarWorkbenchKit";

		m_Name = "#dismantle";	// action name in game
		...
		m_IngredientAddHealth[0] = -20;	// -1 = do nothing
