class Zen_CraftCarWorkbenchKit extends RecipeBase
{
	override void Init()
	{
		int recipeMakeCost = 60;
		int recipeResourceCost = 5;
		string makeItem = "Nail";
		string resourceItem = "MetalPlate";
		string resultItem = "Zen_CarWorkbenchKit";

		m_Name = "#craft #STR_CfgVehicles_ZenCarWorkbenchKit0";	// action name in game
	...
	{
		return ZenModEnabled("ZenCarWorkbench") && super.CanDo(ingredients, player);
	}
}