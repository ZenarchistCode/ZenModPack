class Zen_CraftTireRack extends RecipeBase
{
	override void Init()
	{
		int recipeMakeCost = 30;
		int recipeResourceCost = 1;
	...
	{
		return ZenModEnabled("ZenTireRack") && super.CanDo(ingredients, player);
	}
}