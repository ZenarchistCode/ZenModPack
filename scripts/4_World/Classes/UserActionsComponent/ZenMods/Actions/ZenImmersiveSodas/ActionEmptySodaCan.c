class ActionEmptySodaCanCB : ActionContinuousBaseCB
{
...
class ActionEmptySodaCan: ActionContinuousBase
{
	void ActionEmptySodaCan()
	{
		m_CommandUID = DayZPlayerConstants.CMD_ACTIONMOD_EMPTY_VESSEL;
		m_SpecialtyWeight = UASoftSkillsWeight.PRECISE_LOW;
		m_CallbackClass = ActionEmptySodaCanCB;
		m_FullBody = false;
