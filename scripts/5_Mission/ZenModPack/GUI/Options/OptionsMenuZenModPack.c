...
class OptionsMenuZenModPack extends ScriptedWidgetEventHandler
{
	...
	void OptionsMenuZenModPack(Widget parent, Widget details_root, GameOptions options, OptionsMenu menu)
	{
		...
		Modded_OptionsMenuZenModPack(parent, details_root, options, menu);
	}

	// Override this if you need to add new settings to this via other 3rd part mods
	void Modded_OptionsMenuZenModPack(Widget parent, Widget details_root, GameOptions options, OptionsMenu menu)
	{
	}
	...
	void UpdateButtons(bool changed = true)
	{
		...
		{
			m_CassetteMusic.SetText("#STR_ZenGui_NoCopyright");
